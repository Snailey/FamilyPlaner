...
*/
    ...
    private fun getEventsFromFirebaseDatabase(day: Int, month: Int, year: Int) {
        ...
        val dbCalendar = FirebaseDatabase.getInstance().getReference("Martinsen").child(NODE_CALENDAR).child(Year).child(date)

        dbCalendar.addListenerForSingleValueEvent(object : ValueEventListener {
